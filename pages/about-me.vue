<template>
  <v-container tag="article" fluid>
    ...
    >
      ...
      <v-col cols="12" class="gradient-bg pa-1" />
    </v-row>
...
<script lang="ts">
import Game from '~/components/about-me/Game.vue'
import Social from '~/components/about-me/Social.vue'
export default {
  components: { Game, Social },
}
</script>
